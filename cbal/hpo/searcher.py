...
Usage::
    ...
    from cbal.hpo.searcher import RandomSearcher
    from cbal.hpo.space import Int, Real, Categorical
...
from cbal.hpo.space import Categorical, Int, Real, SearchSpace, sample_config
